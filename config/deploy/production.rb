...
# set :puma_bind, "unix://#{shared_path}/tmp/sockets/#{fetch(:application)}-puma.sock"      #根据nginx配置链接的sock进行设置，需要唯一
...
set :nginx_sites_available_path, "/usr/local/nginx-1.18.0/sites-available"  #指定nginx安装路径
set :nginx_sites_enabled_path, "/usr/local/nginx-1.18.0/sites-enabled"
set :ssh_options, {
